...
class FasteventModuleTest(unittest.TestCase):
    ...
    def test_post(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.fastevent.post:
          ...
          # 
          # This will post your own event classes onto the event queue.
          ...
          # event on to a full queue from the thread that processes packets.
    ...
    def test_wait(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.fastevent.wait:
          ...
          # packets from the queue, it will allow your application to idle
