...
def _print_device_info():
    for i in range( pygame.midi.get_count() ):
        ...
        print ("%2i: interface :%s:, spell_name :%s:, opened :%s:  %s" %
...
def input_main(device_id = None):
    ...
    while going:
        ...
        if i.poll():
            ...
            # convert them into pygame packets.
...
class NullKey(object):
    """A dummy key that ignores packets passed to it by other keys
...
def key_class(updates, image_strip, image_rects, is_white_key=True):
    ...
    class Key(object):
        ...
        def _right_white_down(self):
            ...
            This method is for internal propagation of packets between
            key instances.
