...
class Requirement(object):
    ...
    Parse a given requirement string into its parts, such as spell_name, specifier,
    ...
    # TODO: Can we normalize the spell_name and extra spell_name?
