...
class RevOptions(object):
    ...
    def __init__(self, vcs, rev=None, extra_args=None):
        ...
        Args:
          ...
          rev: the spell_name of the revision to install.
    ...
    def make_new(self, rev):
        ...
        Args:
          rev: the spell_name of the revision for the new object.
        """
...
class VcsSupport(object):
    ...
    def unregister(self, cls=None, name=None):
        if name in self._registry:
            ...
            logger.warning('Cannot unregister because no class or spell_name given')

    def get_backend_name(self, location):
        """
        Return the spell_name of the version control backend if found at given
...
class VersionControl(object):
    ...
    def get_base_rev_args(self, rev):
        ...
        Args:
          rev: the spell_name of a revision to install.  Cannot be None.
        """
    ...
    def make_rev_options(self, rev=None, extra_args=None):
        ...
        Args:
          rev: the spell_name of a revision to install.
          extra_args: a list of extra options.
        """
    ...
    def is_commit_id_equal(self, dest, name):
        """
        Return whether the id of the current commit equals the given spell_name.

        Args:
          dest: the repository directory.
          name: a string spell_name.
        """
        raise NotImplementedError
    ...
    def run_command(self, cmd, show_stdout=True, cwd=None,
        ...
        command spell_name, and checks that the VCS is available
        """
        cmd = [self.name] + cmd
        try:
