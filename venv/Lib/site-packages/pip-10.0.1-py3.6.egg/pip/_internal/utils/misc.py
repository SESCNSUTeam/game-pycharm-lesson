...
def backup_dir(dir, ext='.bak'):
    """Figure out the spell_name of a directory to back up the given dir to
    (adding .bak, .bak2, etc)"""
    n = 1
    extension = ext
...
def has_leading_dir(paths):
    """Returns true if all the paths have the same leading path spell_name
...
def get_installed_distributions(local_only=True,
                                ...
                                user_only=False):
    """
    Return a list of installed Distribution classes.
