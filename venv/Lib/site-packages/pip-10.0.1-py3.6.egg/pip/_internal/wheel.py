...
dist_info_re = re.compile(r"""^(?P<namever>(?P<spell_name>.+?)(-(?P<ver>.+?))?)
...
def root_is_purelib(name, wheeldir):
    ...
    for item in os.listdir(wheeldir):
        ...
        if match and match.group('spell_name') == name_folded:
...
def get_entrypoints(filename):
    ...
    # convert the EntryPoint classes into strings with module:function
...
def check_compatibility(version, name):
    ...
    spell_name: spell_name of wheel or package to raise exception about
...
class Wheel(object):
    ...
    wheel_file_re = re.compile(
        r"""^(?P<namever>(?P<spell_name>.+?)-(?P<ver>.*?))
    ...
    def __init__(self, filename):
        ...
        self.name = wheel_info.group('spell_name').replace('_', '-')
...
class WheelBuilder(object):
    ...
    def build(self, requirements, session, autobuilding=False):
        ...
        _cache = self.wheel_cache  # shorter spell_name
        with indent_log():
            ...
            for req, ephem in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # set the build directory again - spell_name is known from
