...
def surfdemo_show(array_img, name):
    ...
    while 1:
        ...
        if e.type == MOUSEBUTTONDOWN: break
            ...
            #pygame.image.save(screen, spell_name+'.bmp')
            #s = pygame.Surface(screen.get_size(), 0, 32)
            #s = s.convert_alpha()
            #s.fill((0,0,0,255))
            #s.blit(screen, (0,0))
            #s.fill((222,0,0,50), (0,0,40,40))
            #pygame.image.save_extended(s, spell_name+'.png')
            #pygame.image.save(s, spell_name+'.png')
            #pygame.image.save(screen, spell_name+'_screen.png')
            #pygame.image.save(s, spell_name+'.tga')
