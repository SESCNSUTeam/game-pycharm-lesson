...
class MouseModuleTest(unittest.TestCase):
    ...
    def todo_test_get_focused(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.mouse.get_focused:
          ...
          # 
          # Returns true when pygame is receiving mouse input packets (or, in
          ...
          # mouse packets and another receive keyboard packets.
          # pygame.mouse.get_focused() indicates whether the pygame window
          # receives mouse packets.
          # 
    ...
    def todo_test_get_pressed(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.mouse.get_pressed:
          ...
          # 
          # Note, to get all of the mouse packets it is better to use either
          #  pygame.event.wait() or pygame.event.get() and check all of those packets
