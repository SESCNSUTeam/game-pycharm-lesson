...
types of classes in the game. There is also a base Group class that simply
...
class Sprite(object):
    """simple base class for visible game classes

    pygame.sprite.Sprite(*groups): return Sprite

    The base class for visible game classes. Derived classes will want to
    ...
    def update(self, *args):
        ...
        method by the same spell_name in the Group class.
...
class Group(AbstractGroup):
    ...
    A simple container for Sprite classes. This class can be subclassed to
