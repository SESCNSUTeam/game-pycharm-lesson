...
class EventTypeTest(unittest.TestCase):
    def test_Event(self):
        # __doc__ (as of 2008-08-02) for pygame.event.Event:
          ...
          # there are no methods attached to Event classes.
...
tests. There is a small window where outside packets from the OS may have effected
...
class EventModuleTest(unittest.TestCase):
    ...
    def test_set_blocked(self):
        # __doc__ (as of 2008-06-25) for pygame.event.set_blocked:
          ...
          # control which packets are allowed on the queue
    ...
    def test_clear(self):
        ...
        self.assert_(pygame.event.poll())  # there are some packets on queue
    ...
    def test_event_name(self):
        ...
        # __doc__ (as of 2008-06-25) for pygame.event.event_name:
          ...
          # get the string spell_name from and event id
    ...
    def todo_test_get_grab(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.event.get_grab:
          ...
          #
          # Returns true when the input packets are grabbed for this application.
