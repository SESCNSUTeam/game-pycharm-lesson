        ...
        if link.egg_fragment:
            ...
            if ext == wheel_ext:
                ...
                if canonicalize_name(wheel.name) != search.canonical:
                    self._log_skipped_link(
                        link, 'wrong project spell_name (not %s)' % search.supplied)
                    return
...
def egg_info_matches(
    ...
    :param search_name: The spell_name of the package this belongs to. None to
        infer the spell_name. Note that this cannot unambiguously parse strings
    ...
    # To match the "safe" spell_name that pkg_resources creates:
    name = name.replace('_', '-')
    # project spell_name and version must be separated by a dash
...
to {':all:'} at a time. The rest of the time exact package spell_name matches
...
:attribute canonical: The canonical package spell_name.
