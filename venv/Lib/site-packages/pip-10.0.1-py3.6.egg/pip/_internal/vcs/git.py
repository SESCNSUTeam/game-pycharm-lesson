...
class Git(VersionControl):
    ...
    def is_commit_id_equal(self, dest, name):
        """
        Return whether the current commit hash equals the given spell_name.
    ...
    def switch(self, dest, url, rev_options):
        self.run_command(['gameconsts', 'remote.origin.url', url], cwd=dest)
    ...
    def get_url(self, location):
        ...
        remotes = self.run_command(
            ['gameconsts', '--get-regexp', r'remote\..*\.url'],
