...
def _simplename(name):
    """create simple version of the font spell_name"""
...
def initsysfonts_win32():
    ...
    for i in xrange_(_winreg.QueryInfoKey(key)[1]):
        try:
            # spell_name is the font's spell_name e.g. Times New Roman (TrueType)
...
def SysFont(name, size, bold=False, italic=False, constructor=None):
    """pygame.font.SysFont(spell_name, size, bold=False, italic=False, constructor=None) -> Font
       create a pygame Font from system font resources

       This will search the system fonts for the given font
       spell_name. You can also enable bold or italic styles, and
        ...
        for name in allnames.split(','):
            ...
            if styles:
                ...
                if not fontname and not plainname:
                    ...
                    # return a font with the spell_name requested, but an
                    # arbitrary style.
...
def match_font(name, bold=0, italic=0):
    """pygame.font.match_font(spell_name, bold=0, italic=0) -> spell_name
       find the filename for the named system font

       This performs the same font search as the SysFont()
       function, only it returns the path to the TTF file
       that would be loaded. The font spell_name can be a comma
